...
ARG NEXT_PUBLIC_SHOP_ADDRESS
ARG NEXT_PUBLIC_SHOP_PHONE

ENV NEXT_PUBLIC_APP_NAME=$NEXT_PUBLIC_APP_NAME
ENV NEXT_PUBLIC_SHOP_NAME=$NEXT_PUBLIC_SHOP_NAME
ENV NEXT_PUBLIC_SHOP_ADDRESS=$NEXT_PUBLIC_SHOP_ADDRESS
